                                        ...
                                        <tbody>
                                            @foreach ($bean_stocks as $i => $bean_stock)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="{{ route('anggota.persediaan.edit', $bean_stock->id) }}" class="btn btn-primary mr-1" data-toggle="tooltip" title="" data-original-title="Ubah data"><i class="fa fa-edit"></i></a>
